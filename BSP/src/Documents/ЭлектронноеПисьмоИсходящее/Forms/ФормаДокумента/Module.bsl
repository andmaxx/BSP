...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	ЭтотОбъект.ПредПросмотр = ЭтотОбъект.ТекстПисьма;
КонецПроцедуры
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, РежимЗаписи, РежимПроведения)
	...
	//++ возможность отправки полноценных HTML писем
	ТекущийОбъект.ТипТекста = Перечисления.ТипыТекстовЭлектронныхПисем.HTML;

	Если ПустаяСтрока(ТекущийОбъект.ТекстHTML)Тогда	
		ТекущийОбъект.ТекстHTML = ТекущийОбъект.Текст;
	КонецЕсли;
	//---
...
&НаСервере
Процедура ТекстПисьмаПриИзмененииНаСервере()
	ЭтотОбъект.ПредПросмотр = ЭтотОбъект.ТекстПисьма;
КонецПроцедуры

&НаКлиенте
Процедура ТекстПисьмаПриИзменении(Элемент)
	ТекстПисьмаПриИзмененииНаСервере();
КонецПроцедуры
